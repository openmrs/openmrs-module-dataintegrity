...
public class DataIntegrityServiceTest extends BaseModuleContextSensitiveTest {
	...
	protected static final String DATAINTEGRITY_RULES_XML =
			"org/openmrs/module/dataintegrity/include/DataIntegrityServiceTest-rules.xml";
	...
	@Test
	@Verifies(value = "should update existing rule with same uuid even with results", method = "saveRule"
			+ "(DataIntegrityRule)")
