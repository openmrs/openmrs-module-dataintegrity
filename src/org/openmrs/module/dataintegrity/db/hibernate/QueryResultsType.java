...
/**
 * Hibernate's Custom Type for {@link QueryResults}
 */
public class QueryResultsType implements UserType, Serializable {
	...
	public Object deepCopy(Object value) throws HibernateException {
		return new QueryResults((QueryResults) value);
	}
	 ...
	 * @see QueryResults#valueOf(String)
	 */
	public Object nullSafeGet(ResultSet rs, String[] names, Object owner)
			throws HibernateException, SQLException {
		String value = (String) Hibernate.STRING.nullSafeGet(rs, names[0]);
		if (value != null)
			return QueryResults.valueOf(value);
		else
			return null;
	}
	...
	public void nullSafeSet(PreparedStatement ps, Object value, int index)
		...
		if (value != null) {
			if (value instanceof java.lang.String) {
				// only in query mode(e.g., Expression.like('queryResults',
				...
				Hibernate.STRING.nullSafeSet(ps,
						IntegrityCheckUtil.serialize((QueryResults) value),
						index);
			}
		} else {
			Hibernate.STRING.nullSafeSet(ps, value, index);
	...
	public boolean equals(Object a, Object b) throws HibernateException {
		if (a == b)
			return true;
		if (a != null && b != null) {
			if (!(a instanceof QueryResults) || !(b instanceof QueryResults))
				return false;
			else
				return a.equals(b);
		}
