...
public class RepairCheckListController extends SimpleFormController {
	...
	private static final Log log = LogFactory.getLog(RepairCheckListController.class);
	...
	protected Map<String, Object> referenceData(HttpServletRequest request, Object command, Errors errors) throws Exception {
		...
		if (stringCheckId != null) {
			...
			IntegrityCheck template = getDataIntegrityService().getIntegrityCheck(checkId);
