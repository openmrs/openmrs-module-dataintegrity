...
@Resource(name = RestConstants.VERSION_1  + DataIntegrityRestController.DATA_INTEGRITY_REST_NAMESPACE + "/result", supportedClass = DataIntegrityResult.class, supportedOpenmrsVersions = { "1.8.*",
        "1.9.*", "1.10.*", "1.11.*", "1.12.*", "2.0.*", "2.1.*" })
public class IntegrityResultResource extends DelegatingCrudResource<DataIntegrityResult> {
    ...
    public DataIntegrityResult getByUniqueId(String uuid) {
        return getDataIntegrityService().getResultByUuid(uuid);
    }
